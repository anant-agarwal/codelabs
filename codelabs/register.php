...
<?php 
			if(isset($_POST['submit']))
			{
				...
				else
				{
					...
					$exec=mysql_query("INSERT INTO users VALUES ('$_POST[uname]','$_POST[passwd]')",$conn) or die("unable to insert in Users_table".mysql_error());
				//$row=mysql_fetch_array($exec);
...
-->
		...
		<div class="main_right" style="width:100%;">
			...
			<p style='text-align:center;'><br/><br/><br/>
				<form name="login" action="register.php" method="post" align="center" >
